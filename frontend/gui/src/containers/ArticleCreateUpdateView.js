...
class ArticleCreateUpdateView extends React.Component {

    constructor(props) {
        super(props);
        this.state = {
            articleId: this.props.match.params.articleID,
            willUpdate: this.props.match.params.articleID !== undefined,
        }
    }
...
ArticleCreateUpdateView = Form.create({})(ArticleCreateUpdateView);
export default ArticleCreateUpdateView;
